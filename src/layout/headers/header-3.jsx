    ...
    <>
      <header className="tp-header-height">
        <div 
          ...
          style={{ backgroundColor: theme === 'dark' ? 'black' : 'transparent' }}
        >
            ...
            <div className="row align-items-center">
              <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-6">
                <div className="header-bottom__logo">
                  {
                     theme === 'dark' ?
                     <Link href="/"><img src="light.svg" alt="" /></Link>
                     :
                     <Link href="/"><img src="dark.svg" alt="" /></Link>
                  }
                </div>
              </div>
                  ...
                  <div className="header-bottom__btn d-flex align-items-center">
                    ...
                    <div className="onOffSwitch">
                      <input
                        ...
                        checked={theme === 'dark'}
                      />
                      <label className="switchLabel" htmlFor="toggle">
                        <span className="onText">light</span>
                        <span className="offText">dark</span>
