   ...
   return (
      <>
               ...
               <div className="row">
                  <div className="col-xl-12">
                     <div className="tp-service-section-wrapper mb-60 d-flex justify-content-between align-items-end">
                        <h3 className={`tp-section-title-3 wow tpfadeLeft ${theme === 'dark' ? 'dark-text' : ''}`} 
                           data-wow-duration=".9s" 
                           data-wow-delay=".3s">
                           {title}
                        </h3>
                        <Link className={`tp-btn-blue-lg tp-btn-hover mb-10 alt-color-black wow tpfadeRight ${theme === 'dark' ? 'dark-text' : ''}`} 
                           data-wow-duration=".9s" 
               ...
               <div className="row">
                  <div className="col-xl-8 wow tpfadeLeft" data-wow-duration=".9s" data-wow-delay=".5s">
                     <div className="tp-service-3-item mb-30 p-relative z-index" style={{ backgroundImage: `url(${bg_img})` }}>
                        <div className={`tp-service-3-icon ${theme === 'dark' ? 'dark-icon' : ''}`}>
                           <Image src={service_img_1} alt="theme-pure" />
                        </div>
                        <div className="tp-service-3-content">
                           <span className={theme === 'dark' ? 'dark-text' : ''}>{service_title}</span>
                           <h4 className={`tp-service-3-title-sm ${theme === 'dark' ? 'dark-text' : ''}`}>
                              <Link href="/">
                                 {service_info}
                              </Link>
                           </h4>
                        ...
                        <div className="tp-service-3-btn">
                           <Link className={`tp-btn-white-solid ${theme === 'dark' ? 'dark-text' : ''}`} href="/">Learn More</Link>
                        </div>
                  ...
                  {service_data.slice(5, 9).map((item, i) => (
                     <div key={i} className="col-xl-4 col-lg-6 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                        <div className="tp-service-sm-item mb-30 d-flex flex-column justify-content-between">
                           <div className={`tp-service-sm-icon ${theme === 'dark' ? 'dark-icon' : ''}`}>
                              {item.icon} 
                           </div>
                           <div className="tp-service-sm-content">
                              <span className={theme === 'dark' ? 'dark-text' : ''}>{item.title}</span>
                              <h3 className={`tp-service-sm-title ${theme === 'dark' ? 'dark-text' : ''}`}>
                                 <Link href="/">{item.description}</Link>
                              </h3>
                              <div className={`tp-service-sm-link ${theme === 'dark' ? 'dark-text' : ''}`}>
         ...
         <style jsx>{`
            ...
            .dark-icon {
               filter: brightness(0) invert(1); /* Adjust this based on your icon */
            }
         `}</style>
      </>
   );
