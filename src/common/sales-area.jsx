                    ...
                    <div className="row align-items-center">
                        <div className="col-xl-6 col-lg-6 order-1 order-md-1 wow tpfadeLeft" data-wow-duration=".9s" data-wow-delay=".5s">
                            <div className="tp-sales-section-box pb-20">
                                <h3 className={`tp-section-title-3 pb-15 ${theme === 'dark' ? 'dark-text' : ''}`}>
                                    {style_service ? dub_title : title}
                                </h3>
                                <p className={`tp-title-anim ${theme === 'dark' ? 'dark-text' : ''}`}>
                                    {description}
                                </p>
                            </div>
                                    ...
                                    {sales_feature.map((item, i) => 
                                        <li key={i} className={item.color}>
                                            <span>
                                                ...
                                                <em className={`${theme === 'dark' ? 'dark-text' : ''}`}>{item.list}</em>
                                            </span>
                                        </li>
                                    )}
                                </ul>
